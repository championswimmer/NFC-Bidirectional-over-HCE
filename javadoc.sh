...
THIS=$(readlink -f "$0")
HERE=$(dirname "$THIS")
OUTDIR="$HERE/libHCE-documentation"
STYLESHEET=""
DOCLETPATH=""
DOCLET=""
EXTRA1=""
...
EXTRA1="-hdf project.name \"libHCE\" "
...
### module:libeventful ###
javadoc $(find libHCE/src/main/java/ -type f | grep "\.java") -d $OUTDIR $STYLESHEET $DOCLETPATH $DOCLET $EXTRA1 $EXTRA2
